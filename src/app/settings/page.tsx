...
const SETTINGS_KEY = "real_estate_settings";
...
export default function SettingsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#070706] px-5 py-8 text-stone-50">
      <div className="mx-auto max-w-xl">
        <Link href="/" className="text-sm text-stone-400 hover:text-white">Back</Link>
        <h1 className="mt-6 text-3xl font-semibold">Settings</h1>
        <form onSubmit={save} className="mt-6 grid gap-4 rounded-lg border border-white/10 bg-white/[0.04] p-5">
          <label className="grid gap-2 text-sm text-stone-400">
            Display name
          ...
          <button className="rounded-lg bg-amber-100 px-4 py-2 font-semibold text-black">Save settings</button>
          {saved && <p className="text-sm text-amber-100">Saved locally.</p>}
        </form>
